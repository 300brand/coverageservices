...
# sky deploy git.300brand.com/coverageservices/WebAPI -host=192.168.20.20
# sky deploy git.300brand.com/coverageservices/Social -host=192.168.20.20
...
#sky stop -service=WebAPI
#sky deploy git.300brand.com/coverageservices/StorageReader -host=192.168.20.20
#sky deploy git.300brand.com/coverageservices/StorageWriter -host=192.168.20.20
#sky deploy git.300brand.com/coverageservices/Search -host=192.168.20.20
#sky deploy git.300brand.com/coverageservices/WebAPI -host=192.168.20.20
